...
cd ~/minor-rproject/ROS2/src
vcs import --input https://raw.githubusercontent.com/ros2/ros2/humble/ros2.repos src
sudo apt upgrade -y
sudo rosdep init
rosdep update
rosdep install --from-paths src --ignore-src --rosdistro humble -y --skip-keys "fastcdr rti-connext-dds-6.0.1 urdfdom_hea>
colcon build --symlink-install
echo "source ~/minor-project/ROS2/install/local_setup.bash" >> ~/.bashrc
source ~/.bashrc
